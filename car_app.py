...
input_data = pd.DataFrame(input_data_imputed, columns=[
    'km_driven', 'mileage(km/ltr/kg)', 'engine', 'max_power', 'seats',
    'age', 'mileage_per_engine', 'log_km_driven', 'engine_squared', 'max_power_cubed'
])
